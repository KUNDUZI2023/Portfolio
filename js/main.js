// Navigation bar effects an scroll
...
//common reveal option to create reveal animation
ScrollReveal({
    // reset: true,
    distance: '60px',
    duration: 2500,
...
//Target elemnts, and specify options to create reveal animation
...
ScrollReveal().reveal('.skills-description, .services-description, .content, .contact-card, .client-swiper, .contact-left h2', { delay: 700, origin: 'left'});
